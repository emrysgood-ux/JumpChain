...
This document corrects all errors from previous Day 1 drafts:

| Element | WRONG (Old) | CORRECT (This Document) |
|---------|-------------|-------------------------|
| Awakening location | Shrine steps / orchard | Chrysanthemum field near Shiroato castle ruins |
| Awakening time | 7:00 AM / various | **14:47:23 JST** |
| Travel method | Walking directly | Bus ride required (several km to village) |
| Eye appearance | Brown only | Brown with **silver flecks** (subtle, Day 1) |
| Heritage visibility | Underplayed | **Half-Japanese features visible** |
| ID document type | Driver's license | **Alien Registration Certificate** (foreign national) |
| Height | 5'4" | **5'10" (178 cm)** |

---

## SHELDON'S DAY 1 PHYSICAL BASELINE

### Appearance (As Restored by Cosmos)
| Feature | Description |
|---------|-------------|
...
|------|----------|---------|
| **Watch** | Left wrist | Seiko mechanical, silver-toned metal, white face, brown leather strap, showing **2:47 PM** |
| **Handkerchief** | Right front pocket | White cotton, sharp creases, folded exactly as Dorothy Mae taught |
| **Loose change** | Left pants pocket | Mix of coins (for bus fare) |

### Wallet Contents (Brown leather, right rear pocket)
...
| **Letter** | From Uncle Kiyoshi (Osaka), handwritten, envelope sealed |
| **Photograph** | Elderly man (Uncle Kiyoshi), worn edges from handling |
| **Property deed** | Tsukino house inheritance documents |

### Clothes (Discovered While Standing)

| Item | Description |
|------|-------------|
| **Slacks** | Gray, neatly pressed |
| **Shirt** | White button-down, collar open, no tie |
| **Shoes** | Black leather, fit perfectly, slight wear at toe |
...
| 8. Dinner Prep | 19:00-19:30 | Main house kitchen | 30 min |
| 9. The Meal | 19:30-20:30 | Main house dining | 60 min |
| 10. Evening Wind-Down | 20:30-21:00 | Main house | 30 min |
| 11. Bath | 21:00-21:30 | Main house (ofuro) | 30 min |
| 12. Walk Home | 21:30-21:45 | Path to Tsukino House | 15 min |
| 13. Preparing for Bed | 21:45-22:00 | Tsukino House | 15 min |
| 14. First Night's Rest | 22:00-sleep | Tsukino House (futon) | Until sleep |
| 15. Dream Sequence | During sleep | Dreamscape | N/A |
...
- [ ] Phase I/II/III
- [ ] "remade"
- [ ] "created" (in supernatural context)
...
| Segment | Sound | Sight | Touch | Smell |
|---------|-------|-------|-------|-------|
| Field crossing | Uguisu calls, grass swishing | Blue sky, mountains, treeline | Grass against ankles, sun warmth | Green growth, wildflowers |
| Treeline | Bird song changes, quieter | Dappled shade, cedar trunks | Cooler air, softer ground | Forest scent, cedar, earth |
| Road emergence | Distant engine, wind | Paved road, signage in Japanese, bus stop shelter | Pavement underfoot | Dust, sun-warmed asphalt |
...
**Sheldon's observation:** His Japanese is perfect. Kyoto-trained accent. NOT Okayama dialect. The woman notices his speech is formal, educated.
...
**NOT 300. NOT 500. EXACTLY 320.**

### Physical State Progression

| Step Range | Heart Rate | Breathing | Legs | Mental State |
|------------|------------|-----------|------|--------------|
| 1-100 | Normal | Easy | Fresh | Curiosity, wonder |
| 101-200 | Elevated | Deeper | Warming | Determination |
| 201-300 | High | Working | Burning | Pushing through |
| 301-320 | Peak | Controlled | Achievement | Arrival |

### Temizu-ya (Purification Fountain) Details
...
| Feature | Sheldon's Observation |
|---------|----------------------|
| **Age** | Late 60s-70s (apparent) |
| **Height** | ~170cm, slightly stooped |
| **Hair** | Gray, shoulder-length ponytail |
| **Eyes** | Kind, intelligent, behind round glasses |
| **Clothing** | Traditional shrine keeper attire |
| **Movement** | Deliberate, measured, unhurried |
| **Voice** | Warm, patient, slightly amused |

### Dialogue Structure

| Exchange | Katsuhito | Sheldon |
|----------|-----------|---------|
...
Katsuhito notices something unusual about this visitor. Not consciously identified, but:
- The way Sheldon holds himself
- Something in the quality of his presence
- The mountain did not resist his approach (Funaho's acceptance)

**SEED PLANTED:** Katsuhito will watch this man carefully.
...
| Feature | Description |
|---------|-------------|
| **Age** | 4 years, 11 months (turns 5 on April 24) |
| **Height** | Small for age |
| **Hair** | Short, black, slightly messy |
| **Eyes** | Brown, wide, curious |
| **Expression** | Serious but open |
| **Clothing** | Kindergarten uniform (navy shorts, white shirt, yellow cap in hand) |
| **Energy** | Boundless, post-school excitement |
...
- Patient, gentle answers
- Gets down to Tenchi's level (physically lowers himself)
- Doesn't talk down to the child
- Genuine interest in Tenchi's questions

**SEED PLANTED:** The foundation of "Sheru-ji" nickname (emerges within days)
...
| Stop | Time | Katsuhito's Comment | Sheldon's Observation |
|------|------|---------------------|----------------------|
...
| Room | Description | Sheldon's Reaction |
|------|-------------|-------------------|
| **Genkan (entry)** | Stone step, shoe storage, sliding door | Proper behavior instinct |
| **Main room** | 6-mat tatami, low table, cushions, tokonoma alcove | Peaceful, lived-in |
| **Kitchen** | Small, traditional, gas stove, modest supplies | Functional, familiar somehow |
| **Bedroom** | Futon closet, empty, aired out | Ready for habitation |
| **Bathroom** | Traditional, ofuro tub, clean | Simple, dignified |
...
Sheldon notices: These tasks are familiar. His hands know what to do. Dorothy Mae's kitchen, a lifetime ago (a lifetime ago in a dead timeline), taught him this. The skills survived.
...
|--------|------|-------------|
| **Rice** | White short-grain | Fresh cooked, perfect texture |
| **Soup** | Miso | Tofu, wakame, green onion |
| **Main** | Grilled mackerel (saba) | Salt-grilled, whole |
| **Side 1** | Pickled daikon | Homemade, shrine garden |
| **Side 2** | Spinach ohitashi | Sesame dressed |
| **Drink** | Hojicha | Roasted green tea |

### Seating Arrangement (Traditional)

| Position | Person |
|----------|--------|
| North (head) | Katsuhito |
| East (guest of honor) | Sheldon |
| South | Tenchi |

### Conversation Topics

| Topic | Initiator | Content |
|-------|-----------|---------|
...
First meal in this new body. Every flavor is vivid, precise. His restored senses register detail his old body would have missed. The rice has individual grains. The fish has layers of flavor. The soup is warmth itself.
...
| Time | Energy Level | Behavior |
|------|--------------|----------|
| 20:30-20:40 | Moderate | Yawning, quieter |
| 20:40-20:50 | Low | Sleepy, clingy with grandfather |
| 20:50-21:00 | Exhausted | Led to bedroom |

### Final Exchange

**Katsuhito:** "You're welcome here, Sheldon-san."  
**Sheldon:** "I'm grateful. More than I can express."  
**Katsuhito:** "Rest well. Tomorrow begins early."  
**Sheldon:** "Good night, Masaki-san."
...
Sheldon examines his body in the bath:
- No scars anywhere
- Skin smooth, unmarked
- Muscle definition he never had
- Everything works perfectly
- Body feels thirty years old, not thirty-eight

### Processing Moment

The heat relaxes something in him. For the first time since awakening, he allows himself to feel:
- He died. He remembers dying.
- He's alive. He doesn't understand how.
- Someone gave him this. Identity, body, place.
- He doesn't know who. Or why.
- But he's here. And he'll earn this chance.
...
First time walking to "his" house. The concept sits strangely. He owns property now. He has an address. He belongs somewhere.
...
| Metric | Value |
|--------|-------|
| Fatigue | High (first full day of existence) |
| Muscle soreness | Mild (320 steps + walking) |
| Hunger | Satisfied |
| Overall | Ready for sleep |
...
**Dream A: Grandmother's Kitchen**
- Dorothy Mae's kitchen, Georgia, decades ago
- Smell of biscuits, morning light through yellow curtains
- Her voice: "You always were too stubborn to stay dead."
- Warmth, safety, love

**Dream B: The White Figure**
- Bright space, no walls, no floor
- Figure in white at edge of vision
- Tall, slender, features unclear
...
| Scene | Target Range | Notes |
|-------|--------------|-------|
| 1. Awakening | 2,500-3,000 | Most critical scene |
| 2. The Walk | 1,200-1,500 | Transition, body awareness |
| 3. Wait & Ride | 1,500-2,000 | First human contact |
| 4. The Ascent | 1,500-1,800 | Physical achievement |
| 5. First Contact | 2,000-2,500 | Major character introduction |
| 6. Meeting Tenchi | 1,500-1,800 | Foundation of key relationship |
| 7. Settling In | 1,200-1,500 | House tour, reality confirmation |
| 8. Dinner Prep | 1,000-1,200 | Skills surfacing |
| 9. The Meal | 2,000-2,500 | Communion, conversation |
| 10. Evening Wind-Down | 800-1,000 | Transition |
| 11. Bath | 1,000-1,200 | Body examination, processing |
| 12. Walk Home | 500-600 | Brief transition |
| 13. Preparing for Bed | 500-600 | Routine establishment |
| 14. First Night's Rest | 800-1,000 | Internal processing |
| 15. Dream Sequence | 600-800 | Seeds for future |
| **TOTAL** | **18,600-23,000** | Full Day 1 coverage |
...
### Location Accuracy
- [x] Field awakening (NOT shrine steps)
- [x] Bus ride required (NOT walking)
- [x] 320 steps (EXACTLY)
- [x] Tsukino House separate from main house

### Physical Details
- [x] Silver flecks in eyes (Day 1)
- [x] Half-Japanese heritage visible
- [x] Height: 5'10" (178 cm)
- [x] All scars removed
- [x] Perfect vision

### Inventory Complete
- [x] Watch (Seiko, 2:47 PM)
...
- [x] No Sailor
- [x] No Lambda
- [x] No Jurai terminology
- [x] No character names (Ryoko, Washu, etc.)
- [x] No "remade" or "created"

### Character Accuracy
- [x] Tenchi age 4 (turns 5 Day 22)
- [x] Katsuhito apparent age 60s-70s
- [x] Sheldon speaks fluent Japanese (pre-death skill)
- [x] Grandmother's influence documented
...
| SEED-006 | Tenchi attachment begins | 6 | "Sheru-ji" nickname, found family |
...
**Supersedes:** All prior Day 1 timeline documents  
**Next Action:** User approval before prose generation
